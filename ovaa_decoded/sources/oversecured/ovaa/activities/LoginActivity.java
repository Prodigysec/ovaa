        ...
        if (loginUtils.isLoggedIn()) {
            ...
            findViewById(R.id.loginButton).setOnClickListener(new View.OnClickListener() { // from class: oversecured.ovaa.activities.LoginActivity.1
                ...
                public void onClick(View view) {
                    String email = ((TextView) LoginActivity.this.findViewById(R.id.emailView)).getText().toString();
                    String password = ((TextView) LoginActivity.this.findViewById(R.id.passwordView)).getText().toString();
